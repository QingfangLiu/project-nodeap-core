...
% using redo _updated2 GLM results
...
for i=1:length(regions)
    modeldir = fullfile(subdir,'nii_for_TMS',sprintf('GLM_%s_updated2',regions(i).seedName));
...
writetable(conn_mat_sub, '../../ProcessedData/SeedStimConn_subs_redo2.xlsx')
