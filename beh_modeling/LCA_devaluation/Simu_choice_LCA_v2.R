...
pdf('Simu_LCA_with_lateral_inhibition_eps_v2.pdf',13,12)
...
saveRDS(choice_outcomes_df_with_betas,
        file = 'Simu_LCA_strength_inhibition_eps_v2.rds')
...
saveRDS(choice_outcomes_df_with_bias,file = 'Simu_LCA_strength_bias_eps_v2.rds')
pdf('Simu_LCA_with_bias_eps_v2.pdf',13,12)
ggarrange(p[[1]],p[[2]],p[[3]],
          p[[4]],p[[5]],p[[6]],
          p[[7]],p[[8]],p[[9]],
          common.legend = T,legend = 'right',
