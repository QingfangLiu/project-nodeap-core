...
for r = 1:n_rest_names % to loop over rest_names
        ...
        func_conn_dir = fullfile(subdir, 'FuncConn_tedana',curr_rest); % path to save the GLM result from tedana result
...
fnames = dir(fullfile(functdir,'s6desc*.nii')); % smoothed data in native space
