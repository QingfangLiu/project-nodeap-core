...
# modifed from the track_w version without hier
...
opt = 'bySess'
model.file = paste0('LearningModel_',opt,'_rerun_track_w_hier.txt')
...
saveRDS(samples,file = paste0('./JagsPosteriors/',opt,'rerun_track_w_hier.rds'))
